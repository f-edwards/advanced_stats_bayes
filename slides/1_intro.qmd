...
```{r}
theta <- 0:4
dhyper(x = 1, m = theta, n = 4-theta, k = 1)
```
...
```{r}
post_tab <- prior_tab |> 
  mutate(post1 = dhyper(x = 1, m = theta, n = 4-theta, k = 1) * prior_exact)
...
```{r}
dhyper(x = 2, m = theta, n = 4-theta, k = 2)
```
...
```{r}
post_tab <- post_tab |> 
  mutate(post2 = dhyper(x = 2, m = theta, n = 4-theta, k = 2) * post1)
post_tab
```
...
# update!
post_tab <- post_tab |> 
  mutate(post3 = dhyper(x = 3, m = theta, n = 4-theta, k = 3) * post2)
post_tab
```
...
p1 <- ggplot(post_tab,
       aes(y = prior_exact,
           x = red)) + 
         geom_col() + 
  labs(subtitle = "Prior", y = "posterior density", x = "")
p2 <- ggplot(post_tab,
       aes(y = post1,
           x = red)) + 
         geom_col() + 
  labs(subtitle = "After 1 draw (red)",y = "", x = "")
p3 <- ggplot(post_tab,
       aes(y = post2,
           x = red)) + 
         geom_col()+ 
  labs(subtitle = "After 2 draws (red, red)",y = "posterior density", x = "number of reds (theta)")
p4 <- ggplot(post_tab,
       aes(y = post3,
           x = red)) + 
         geom_col()+ 
  labs(subtitle = "After 3 draws (red, red, red)",y = "", x = "number of reds (theta)")
...
p1 <- ggplot(post_tab,
       aes(y = prior_exact,
           x = red)) + 
         geom_col() + 
  labs(subtitle = "Prior", y = "probability", x = "")
p2 <- ggplot(post_tab,
       aes(y = dhyper(x = 1, m = theta, n = 4-theta, k = 1),
           x = red)) + 
         geom_col() + 
  labs(subtitle = "After 1 draw (red)", x = "", y = "")
p3 <- ggplot(post_tab,
       aes(y = dhyper(x = 2, m = theta, n = 4-theta, k = 2),
           x = red)) + 
         geom_col()+ 
  labs(subtitle = "After 2 draws (red, red)",y = "probability", x = "number of reds (theta)")

p4 <- ggplot(post_tab,
       aes(y = dhyper(x = 3, m = theta, n = 4-theta, k = 3),
           x = red)) + 
         geom_col()+ 
  labs(subtitle = "After 3 draws (red, red, red)", x = "number of reds (theta)", y = "")
